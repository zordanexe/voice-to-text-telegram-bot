...
Локально также проверено распознавание озвученной русской фразы настоящей моделью. Проверку конкретного микрофона и ответа в Telegram выполняйте отдельно по шагам выше.
